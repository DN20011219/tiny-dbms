...
//     static BufferPool *m_SingleInstance;  // singleton object
...
//     ~BufferPool()
//     {
//         // std::cout << "____BufferPool on deleted___" << std::endl;
//         delete[] data_memory_blocks;
//         delete[] table_memory_blocks;
//         delete[] data_replacer;
//         delete[] table_replacer;
//         // std::cout << "____BufferPool has been deleted___" << std::endl;
//     }

//     BufferPool(const BufferPool &signal);

//     const BufferPool &operator=(const BufferPool &signal);

// public:

//     // get singleton BufferPool
...
//     // use replacer to get a free table block to store the information about input block
//     void GetFreeTableBlock(char*& data, std::string table_sign, default_address_type block_offset)
//     {       
